...
<body>
<form action="register" method="POST" class="container-fluid" style="padding-top:3%"
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="col-md-9">
                <nav class="navbar navbar-default" role="registrationForm" style="min-height: 1000px;">
                    ...
                    <div class="container-fluid">
                        <form role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="address" class="form-control" name="address" id="address_id"
                            ...
                            <div class="btn-group btn-group-sm" data-toggle="buttons">
                                <label class="btn btn-default" style="min-width: 120px;">
                                    <input type="radio" name="pol" id ="gender_male">Male.
                                </label>

                                <label class="btn btn-default" style="min-width: 120px;">Female.
                                    <input type="radio" name="pol" id ="gender_female">
                                </label>

                                <label class="btn btn-default" style="min-width: 120px;">No matter.
                                    <input type="radio" name="pol" id ="gender_unknown">
                                </label>
